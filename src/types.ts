export type View = 'dashboard' | 'contacts' | 'pipeline' | 'reports' | 'settings' | 'activities' | 'contact-detail' | 'contact-form' | 'products' | 'product-form' | 'finance' | 'finance-form' | 'expenses' | 'expenses-form' | 'invoices' | 'invoice-form' | 'integrations';
